...
``datasets/_example_output/M-042_ddr_lesion_segmentation/`` relative to the pipeline's
``DATA_ROOT``.
...
import importlib
_phase2_mod = importlib.import_module("m122_chexlocalize")
